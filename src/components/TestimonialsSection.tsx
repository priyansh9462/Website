...
const TestimonialsSection = () => {
  ...
  return (
    <section ref={sectionRef} className="py-32 bg-gradient-to-br from-primary via-primary/95 to-primary/90 text-primary-foreground relative overflow-hidden">
          ...
          <div ref={testimonialRef} className="relative bg-background/15 backdrop-blur-xl rounded-3xl p-12 md:p-16 border border-white/20 shadow-2xl">
            ...
            <div className="flex flex-col md:flex-row items-center justify-center space-y-6 md:space-y-0 md:space-x-8">
              <img 
                ...
                className="w-[200px] h-[300px]  rounded-full object-cover border-4 border-yellow-300 shadow-xl transition-all duration-500"
            ...
            <div className="flex items-center justify-between mt-12 pt-8 border-t border-white/20">
              <Button
                ...
                className="border-2 border-primary-foreground/30 text-primary-foreground hover:bg-primary-foreground hover:text-primary transition-all duration-300"
              >
