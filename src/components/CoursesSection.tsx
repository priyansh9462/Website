...
const CoursesSection = () => {
  ...
  return (
    <section ref={sectionRef} id="courses" className="relative py-24 bg-gradient-to-br from-background via-secondary/20 to-background overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div ref={sectionsContainerRef} className="grid grid-cols-1 lg:grid-cols-2 gap-16">
          {Object.entries(courseSections).map(([key, section]) => {
            ...
            return (
              <div
                key={key}
                className="relative group p-10 rounded-3xl border border-border bg-background/50 backdrop-blur-md text-center space-y-6 section-header overflow-hidden transition-all duration-500 transform hover:scale-105 hover:shadow-2xl hover:ring-2 hover:ring-offset-2 hover:ring-primary"
              >
                {/* Hover Overlay */}
                <div
                  className={`absolute inset-0 flex flex-col items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-500 z-20 
                ...
                >
                  ...
                  <Button
                    ...
                    className={`mt-4 bg-white ${
                      key === 'BCA' ? 'text-blue-600 hover:bg-blue-50' : 'text-purple-600 hover:bg-purple-50'
                    } font-bold px-8 py-4 shadow-lg hover:scale-105 transition-transform`}
        ...
        {/* <div className="text-center mt-20">
          <Button
            size="lg"
            className="group bg-gradient-to-r from-primary via-blue-600 to-purple-600 hover:scale-110 transition-all duration-300 shadow-xl hover:shadow-2xl px-8 py-4"
