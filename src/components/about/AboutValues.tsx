...
const AboutValues = () => {
  ...
  useEffect(() => {
    // Values section with morphing cards
  ...
  return (
    <section className="py-32 bg-gradient-to-br from-accent/5 to-background">
      <div className="container mx-auto px-6">
        ...
        <div ref={valuesRef} className="grid grid-cols-1 md:grid-cols-2 gap-12">
          {values.map((value, index) => (
            <div key={index} className="group p-10 rounded-3xl bg-gradient-to-br from-background to-accent/5 border border-border/50 hover:border-primary/30 transition-all duration-700 hover:shadow-2xl hover:scale-105">
