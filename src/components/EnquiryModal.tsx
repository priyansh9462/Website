        ...
        <Card className="bg-white border shadow-2xl">
          <CardHeader className="text-center relative">
            <Button
              variant="ghost"
              size="icon"
              className="absolute right-2 top-2 hover:scale-110 transition-all duration-300"
              onClick={handleClose}
            >
              <X className="w-5 h-5" />
            </Button>
            ...
            {!isSubmitted ? (
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <select
                      ...
                      className="flex h-10 w-full rounded-md border border-gray-300 bg-white px-3 py-2 text-sm transition-all duration-300 focus:scale-105 focus:outline-none focus:ring-2 focus:ring-blue-500"
                    >
                ...
                <div className="flex gap-4">
                  <Button 
                    type="submit" 
                    className="flex-1 bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 hover:scale-105 transition-all duration-300 shadow-lg text-white"
                    size="lg"
                  >
              ...
              <div className="text-center space-y-6 py-8">
                ...
                <Button 
                  onClick={handleClose}
                  className="bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 hover:scale-105 transition-all duration-300 text-white"
                  size="lg"
                >
                  Explore Our Website
                </Button>
