...
const NewsAlert = () => {
  ...
  useEffect(() => {
    ...
    // Pulse effect for the bell icon
  ...
  return (
    <div 
      ref={alertRef}
      className="fixed top-20 left-1/2 transform -translate-x-1/2 z-40 w-full max-w-4xl px-4"
    >
      <div 
        ref={contentRef}
        className="relative bg-gradient-to-r from-yellow-400 via-orange-500 to-red-500 rounded-2xl shadow-2xl overflow-hidden"
      >
        ...
        <div className="relative flex items-center justify-between p-6">
          ...
          <div ref={textRef} className="flex-1 mx-6">
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between">
              ...
              <div className="mt-3 sm:mt-0 sm:ml-4">
                <Button 
                  size="sm"
                  className="bg-white text-orange-600 hover:bg-white/90 font-semibold shadow-lg hover:scale-105 transition-all duration-300"
          ...
          <button
            ref={closeRef}
            onClick={handleClose}
            className="flex-shrink-0 w-8 h-8 bg-white/20 backdrop-blur-sm rounded-full flex items-center justify-center hover:bg-white/30 transition-all duration-300 hover:scale-110"
          >
