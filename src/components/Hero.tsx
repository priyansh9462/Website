    ...
    <section ref={heroRef} id="home" className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-20 container mx-auto px-6 text-center text-white">
        <div className="max-w-5xl mx-auto">
          ...
          {/* Logo Image instead of Heading */}
          <img
            ref={headingRef}
            src="ENGNEERING COLLEGE BARAN (2).png"
            alt="Logo"
            className="mx-auto mb-10 w-70 md:w-96"
          />

          {/* Subtitle */}
         <p
  ref={subtitleRef}
  className="text-4xl md:text-5xl mb-12 max-w-3xl mx-auto font-900 leading-relaxed block text-white"
  style={{ fontFamily: "'Rock Salt', sans-serif" }}
>
