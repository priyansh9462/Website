...
const Topbar = () => {
  ...
  return (
    <header className="cms-topbar border-b border-[#DEDACC] bg-gradient-to-r from-[#FFFDF6] via-white to-[#F7F9FF] shadow-sm">
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="flex items-center gap-3 pl-3 border-l border-[#DEDACC]">
            ...
            <Button
              ...
              variant="outline"
              size="sm"
              className="border-[#CCD4E3] text-[#112F68] hover:bg-[#F3F6FF] bg-transparent"
            >
              Sign out
            </Button>
          </div>
