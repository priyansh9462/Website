...
const StudentPortal = () => {
  ...
  useEffect(() => {
    if (isLoggedIn && dashboardRef.current) {
      ...
      // Continuous animations for dashboard
  ...
  if (!isLoggedIn) {
    return (
      <div ref={containerRef} className="min-h-screen bg-gradient-to-br from-primary/5 via-background to-primary/10">
        {/* Hero Section */}
          ...
          <Card className="premium-border backdrop-blur-xl bg-card/80 shadow-premium">
            ...
            <CardContent>
              <form onSubmit={handleLogin} className="space-y-6">
                ...
                <Button 
                  type="submit" 
                  className="w-full h-12 text-lg bg-gradient-to-r from-primary to-primary/80 hover:shadow-glow transition-all duration-300"
                >
                  Sign In to Portal
                </Button>
  ...
  return (
    <div ref={dashboardRef} className="min-h-screen bg-gradient-to-br from-primary/5 via-background to-primary/10" style={{ display: 'none' }}>
      <div className="flex">
        {/* Sidebar */}
        <div ref={sidebarRef} className="w-64 bg-card/80 backdrop-blur-xl border-r border-border/50 min-h-screen p-6">
          ...
          <nav className="space-y-2">
            {[
              ...
              <button
                key={index}
                className={`w-full flex items-center space-x-3 px-4 py-3 rounded-lg transition-all duration-300 hover:bg-primary/10 hover:scale-105 ${
        ...
        <div className="flex-1 p-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
            {[
              ...
              <div
                key={index}
                ref={addToStatsRef}
                className="bg-card/80 backdrop-blur-xl p-6 rounded-xl border border-border/50 hover:shadow-glow transition-all duration-300 cursor-pointer"
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <Card 
              ref={addToCardsRef}
              className="premium-border backdrop-blur-xl bg-card/80 hover:shadow-glow transition-all duration-300"
            ...
            >
              ...
              <CardContent className="grid grid-cols-2 gap-4">
                {[
                  ...
                  <button
                    key={index}
                    className="flex flex-col items-center p-6 bg-muted/50 rounded-lg hover:scale-105 transition-all duration-300 group"
                  >
