...
const ApplyNow = () => {
  ...
  useEffect(() => {
    ...
    // Card entrance with ScrollTrigger
                  ...
                  <form ref={formRef} onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
                      ...
                      <FormField
                        ...
                        render={({ field }) => (
                          <FormItem className="form-field">
                            ...
                            <FormControl>
                              <Textarea 
                                placeholder="Describe your educational background, including schools attended, degrees earned, and relevant achievements"
                                className="resize-none h-24 transition-all duration-300 focus:scale-105"
                                {...field} 
                              />
                            </FormControl>
                            <FormMessage />
                      ...
                      <FormField
                        ...
                        render={({ field }) => (
                          <FormItem className="form-field">
                            ...
                            <FormControl>
                              <Textarea 
                                placeholder="Tell us about yourself, your goals, and why you want to join our university (minimum 100 characters)"
                                className="resize-none h-32 transition-all duration-300 focus:scale-105"
                                {...field} 
                              />
                            </FormControl>
                            <FormMessage />
                    ...
                    <div className="pt-6">
                      <Button
                        ...
                        className="w-full bg-gradient-to-r from-primary to-primary/80 hover:scale-105 transition-all duration-300 h-12 text-lg font-semibold relative overflow-hidden group"
                      >
