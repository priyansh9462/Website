          ...
          <CardContent className="p-6">
            <Tabs value={activeTab} onValueChange={handleTabChange} className="w-full">
                            ...
                            <TableCell>
                              <div className="flex space-x-2">
                                ...
                                <Button 
                                  size="sm" 
                                  variant="destructive"
                                  onClick={(e) => animateDelete(e.currentTarget, 'course', course.id)}
                                >
              ...
              <TabsContent value="testimonials" className="space-y-6">
                ...
                <div className="grid gap-4">
                  {testimonials.map((testimonial) => (
                    <Card key={testimonial.id} className="hover:shadow-md transition-shadow card-item">
                      <CardContent className="p-6">
                        <div className="flex justify-between items-start">
                          ...
                          <div className="flex space-x-2">
                            ...
                            <Button 
                              size="sm" 
                              variant="destructive"
                              onClick={(e) => animateDelete(e.currentTarget, 'testimonial', testimonial.id)}
                            >
                              <Trash2 className="h-4 w-4" />
                            </Button>
                          </div>
              ...
              <TabsContent value="events" className="space-y-6">
                ...
                <div className="grid gap-4">
                  {events.map((event) => (
                    <Card key={event.id} className="hover:shadow-md transition-shadow card-item">
                      <CardContent className="p-6">
                        <div className="flex justify-between items-start">
                          <div className="flex-1">
                            <div className="flex items-center space-x-2 mb-2">
                          ...
                          <div className="flex space-x-2">
                            ...
                            <Button 
                              size="sm" 
                              variant="destructive"
                              onClick={(e) => animateDelete(e.currentTarget, 'event', event.id)}
                            >
                              <Trash2 className="h-4 w-4" />
                            </Button>
                          </div>
