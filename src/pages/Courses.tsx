            ...
            return (
              <div key={sectionKey} className="mb-20">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                  {section.branches.map((course, index) => (
                    <Card 
                      key={course.id} 
                      className={`course-card hover-scale group cursor-pointer overflow-hidden ${
                        course.featured ? 'ring-2 ring-primary shadow-xl' : 'shadow-lg'
      ...
      <section className="py-20 bg-gradient-to-r from-primary/10 via-purple-500/10 to-pink-500/10">
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button 
              size="lg" 
              className="group bg-gradient-to-r from-primary to-primary/80 hover:scale-105 transition-all duration-300"
