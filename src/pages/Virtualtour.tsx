              ...
              <div className="flex flex-wrap items-center justify-between gap-4">
                <div className="flex items-center gap-4">
                  <Button
                    ...
                    className="bg-gradient-to-r from-blue-500 to-indigo-600 hover:from-blue-600 hover:to-indigo-700 shadow-lg hover:scale-105 transition-all"
                  >
            ...
            <div className="space-y-4">
              ...
              {tourLocations.map((location) => (
                <Card
                  key={location.id}
                  ref={addLocationRef}
                  className={`location-card cursor-pointer transition-all duration-500 hover:shadow-xl hover:-translate-y-1 ${
                  ...
                  <CardContent className="p-4">
                    <div className="flex items-start gap-3">
                      <div className={`w-3 h-3 rounded-full mt-2 ${
                        currentLocation.id === location.id ? 'bg-blue-500' : 'bg-gray-300'
                      }`} />
                      <div>
                ...
                <CardContent className="p-0">
                  <div className="tour-viewer relative">
                    ...
                    {currentLocation.hotspots.map((hotspot, index) => (
                      <button
                        key={index}
                        className={`absolute w-8 h-8 bg-blue-500 rounded-full border-4 border-white shadow-lg hover:scale-125 transition-all duration-300 ${
                          selectedHotspot === index ? 'bg-red-500 animate-pulse' : 'hover:bg-blue-600'
                        }`}
                        style={{ 
                          left: `${hotspot.x}%`, 
                          top: `${hotspot.y}%`,
                    ...
                    {selectedHotspot !== null && (
                      <div className="absolute bottom-4 left-4 right-4 bg-white/95 backdrop-blur-sm rounded-lg p-4 shadow-xl animate-fade-in">
