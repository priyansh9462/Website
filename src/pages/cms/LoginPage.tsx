...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen bg-[#959DAA] p-4 sm:p-6">
          ...
          <div className="p-7 sm:p-9 lg:p-10">
            ...
            <form onSubmit={handleSignIn} className="space-y-4">
              <input
                ...
                className="w-full rounded-full border border-slate-300 bg-white/85 px-5 py-3 text-slate-900 placeholder:text-slate-500 focus:outline-none focus:ring-4 focus:ring-[#112F68]/15"
                required
              />
              <input
                type="password"
              ...
              <button
                type="submit"
                className="w-full rounded-full bg-[#F5D45A] py-3 text-lg font-semibold text-slate-900 transition-colors hover:bg-[#efca43]"
              >
                Sign In
              </button>
            </form>
