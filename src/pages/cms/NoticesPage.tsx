...
export default function NoticesPage() {
  ...
  const openAttachment = (notice: Notice) => {
    if (!notice.file_data_url) return
    try {
    ...
    <div className="space-y-6">
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
            ...
            <div key={n.id} className="border rounded-lg p-4">
              <div className="flex items-start justify-between gap-3">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <ConfirmDelete
                    title="Delete notice"
                    description="This notice will be removed permanently."
                    onConfirm={() => {
          ...
          {sorted.length === 0 && (
            <div className="text-center text-sm text-muted-foreground py-6">No notices available.</div>
          )}
        </CardContent>
      </Card>
        ...
        <DialogContent>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <Select
                value={form.audience}
                onValueChange={(value) => setForm((prev) => ({ ...prev, audience: value as Audience }))}
              >
                <SelectTrigger>
                  <SelectValue />
                </SelectTrigger>
