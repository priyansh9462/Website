            ...
            <Card className="max-w-md w-full premium-border award-shadow text-center">
              <CardContent className="p-8 space-y-6">
                ...
                <Button 
                  ...
                  className="premium-gradient hover:scale-105 transition-all duration-300"
                >
        ...
        <div className="container mx-auto px-6">
          ...
          <div ref={statsRef} className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-20">
            {[
              ...
              <Card key={stat.label} className="premium-border text-center hover:scale-105 transition-all duration-300">
            ...
            <div ref={contactInfoRef} className="space-y-8">
              ...
              <div className="grid gap-6">
                {contactInfo.map((info, index) => (
                  <Card key={info.title} className="premium-border hover:scale-105 transition-all duration-300 cursor-pointer">
                    <CardContent className="p-6">
              ...
              <Card className="premium-border award-shadow">
                ...
                <CardContent>
                  <form onSubmit={handleSubmit} className="space-y-6">
                    <div className="grid md:grid-cols-2 gap-4">
                      <div className="space-y-2">
                        ...
                        <Input
                          ...
                          onFocus={(e) => handleFieldFocus(e.target)}
                          onBlur={(e) => handleFieldBlur(e.target)}
                          required
                    ...
                    <Button 
                      type="submit" 
                      className="w-full premium-gradient hover:scale-105 transition-all duration-300 shadow-lg"
                      size="lg"
                    >
