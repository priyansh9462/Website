    ...
    return (<div className="space-y-6">
            ...
            <Table>
              ...
              <TableBody>
                ...
                setOpen(true);
                        ...
                        <ConfirmDelete title="Delete teacher" description="This will permanently remove the teacher." onConfirm={() => {
      ...
      <Dialog open={open} onOpenChange={setOpen}>
        <DialogContent>
          ...
          <TeacherForm initial={edit ?? undefined} onCancel={() => setOpen(false)} onSubmit={(values) => {
            if (edit) {
